...
# ERROR
MSG_ERROR_COMPONENT_INVALID_LENGTH = 'Довжина компонента словникової пари (слово, переклад, транскрипція, анотація) має бути від {min_length} до {max_length} символів.'
MSG_ERROR_COMPONENT_INVALID_CHARS = 'Компонент словникової пари (слово, переклад, транскрипція, анотація) може містити лише літери, цифри та символи: "{allowed_chars}".'

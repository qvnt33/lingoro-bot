...
def get_inline_kb_create_vocab_name(apply_old_name=False) -> InlineKeyboardMarkup:
    ...
    btn_apply_old_name = InlineKeyboardButton(text='Залишити поточну назву',
                                            callback_data='apply_old_name')
    kb.row(btn_cancel, btn_apply_old_name, width=1) if apply_old_name else kb.row(btn_cancel, width=1)
...
#     btn_back_to_name = InlineKeyboardButton(text='Назад',
#                                             callback_data='back_to_vocab_note')
#     btn_back_to_name = InlineKeyboardButton(text='Зберегти',
#                                             callback_data='back_to_vocab_name')

#     kb.row(btn_skip_note, btn_cancel_add, btn_back_to_name, width=1)

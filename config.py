...
ALLOWED_CHARACTERS = '-_ '  # Дозволені символи для назви словника та словникових пар
...
MAX_COUNT_WORDS_WORDPAIR = 3  # Максимальна кількість "слів"

# Кількість перекладів у словниковій парі
MIN_COUNT_TRANSLATIONS_WORDPAIR = 1  # Мінімальна кількість "перекладів"
MAX_COUNT_TRANSLATIONS_WORDPAIR = 3  # Максимальна кількість "перекладів"
...
# Довжина перекладу в словниковій парі
MIN_LENGTH_TRANSLATION_WORDPAIR = 1  # Мінімальна кількість символів
MAX_LENGTH_TRANSLATION_WORDPAIR = 30  # Максимальна кількість символів

# Довжина анотації в словниковій парі
MIN_LENGTH_ANNOTATION_WORDPAIR = 0  # Мінімальна кількість символів
